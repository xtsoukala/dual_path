...
""" based on tutorial: https://github.com/rougier/neural-networks, will be modified further """
...
class Elman:
    ...
    def propagate_backward(self, target, lrate=0.1, momentum=0.1):
        ...
        for i in range(len(self.shape) - 2, 0, -1):
            delta = np.dot(deltas[0], self.weights[i].T) * tanh_prime(self.layers[i])
...
if __name__ == '__main__':
    ...
    for i in range(samples.size):
        ...
        print '               Network output: %s\n' % (o == o.max()).astype(float)
